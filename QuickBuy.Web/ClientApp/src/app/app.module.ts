...
import { PesquisarProdutoComponent } from './produto/pesquisa/pesquisa.produto.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: "pesquisar-produto", component: PesquisarProdutoComponent, canActivate: [GuardaRotas] },
